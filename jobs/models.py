...
class Route(models.Model):
    ...
    description = models.IntegerField(
        default=2, choices=DESCRIPTIONCHOICES, null=True, blank=True
    )
...
class Job(models.Model):
    ...
    helpers = models.IntegerField(
        default=1, choices=HELPERCHOICES, null=True, blank=True
    )
    floors = models.IntegerField(
        default=0, choices=FLOORSCHOICES, null=True, blank=True
    )
    shuttle = models.IntegerField(
        default=0, choices=SHUTTLECHOICES, null=True, blank=True
    )

    payment_option = models.CharField(
        default="CASH", choices=PAYMENTOPTIONS, max_length=50, null=True, blank=True
    )
    driver_note = models.TextField(
        default="No note left", max_length=1000, null=True, blank=True
    )
    price_adjustment_justification = models.TextField(
        default="No note left", max_length=2500, null=True, blank=True
    )

    hear_about_us = models.CharField(
        default="None", max_length=100, null=True, blank=True, choices=HEARABOUTUS
    )

    # ... referal code for discount
    referal_code = models.CharField(
        max_length=150, null=True, blank=True, default="xcrossinglines"
    )
    referal_discount = models.FloatField(default=0.0, null=True, blank=True)

    vehicle_size = models.FloatField(
        default=1.0, choices=VSIZECHOICES, null=True, blank=True
    )
    ...
    job_completed = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    job_canceled = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    job_cancellation_feedback_sent = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    job_invoice_sent = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    feedback_email_sent = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    job_out_sourced = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    give_extra_discount = models.BooleanField(
        default=NO, choices=YES_NO_CHOICES, null=False, blank=False
    )
    set_price_adjustment = models.BooleanField(
        default=YES, choices=YES_NO_CHOICES, null=False, blank=False
    )
